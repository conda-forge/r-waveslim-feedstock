...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-waveslim-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-waveslim-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-waveslim-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-waveslim-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-waveslim-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-waveslim-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-waveslim/badges/version.svg)](https://anaconda.org/conda-forge/r-waveslim)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-waveslim/badges/downloads.svg)](https://anaconda.org/conda-forge/r-waveslim)
